...
MCmarker Desk 是一款專為漢字中古音研究和查詢設計的輕量級懸浮工具，其实就是網頁插件MCmarker Online（漢字中古音韻標記器）的桌面版，不再限製於在線網頁。程序啟動後，會在桌面邊緣顯示一個 50 x 50 像素的懸浮圖標，這就是 MCMarker 的主入口。（圖標是麥麥的某個頭像，來源@章鱼虫bobo，神奇畫手。）
